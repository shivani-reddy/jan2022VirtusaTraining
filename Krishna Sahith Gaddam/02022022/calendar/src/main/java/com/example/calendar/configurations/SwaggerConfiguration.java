package com.calender.calendarApi.configurations;
...
public class SwaggerConfiguration {
        ...
        public Docket apiDocketcategoryparamv10() {
                return new Docket(DocumentationType.SWAGGER_2)
                                .groupName("calendar-api-param-1.0")
                                .select()
                                .apis(RequestHandlerSelectors
                                                .basePackage("com.calender.calendarApi"))
        ...
        private ApiInfo getApiInfo() {
                return new ApiInfo(
                                "Calendar API",
                                "App to represent Needed Calendar Data",
                                "0.0.1-SNAPSHOT",
                                "Terms of Service",
