...
public class TraderController {
	...
	public ResponseEntity<?> getTraderByFields(@PathVariable("traderId") long traderId,
		...
		//put
//	@PutMapping(value="/{traderId}",params = "version=1.0")
//	public ResponseEntity<?> updateTrader(@PathVariable("traderId") long traderId, @RequestBody Trader trader){
//		Trader traderObj=this.traderService.updateTraderByTraderId(traderId, trader);
//		if(traderObj!=null)
//			return ResponseEntity.status(HttpStatus.ACCEPTED).body(trader);
//		else
//			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Trader Not Created");
//
//	}
